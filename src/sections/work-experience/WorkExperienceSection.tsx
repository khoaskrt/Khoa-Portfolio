...
export function WorkExperienceSection() {
  ...
  return (
    ...
    >
      <header className="mx-auto flex w-full max-w-[1320px] items-center justify-between gap-4 font-sans text-[13px] font-normal leading-none tracking-[0.08em] text-[oklch(0.34_0.01_255)]">
      ...
      <div className="mx-auto mt-10 grid w-full max-w-[1320px] gap-10 lg:mt-18 lg:grid-cols-[1.18fr_0.92fr] lg:gap-16">
        <h2 className="max-w-[7.2ch] font-display text-[clamp(3.5rem,9.2vw,8.3rem)] font-bold leading-[0.9] tracking-[-0.04em] text-[oklch(0.12_0.01_255)]">
